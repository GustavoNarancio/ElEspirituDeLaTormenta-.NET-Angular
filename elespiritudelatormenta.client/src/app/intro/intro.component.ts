...
import { Router } from '@angular/router'; // Importamos el motor de rutas
...
export class IntroComponent implements OnInit {
  ...
  // Variables de control de la intro
  escena: number = 1;
  ...
  // EL CONSTRUCTOR: Aquí "inyectamos" el router para poder usarlo abajo
  ...
  // ESTA FUNCIÓN ES LA QUE CAMBIA LA URL
  finalizarIntro() {
    // Le decimos a Angular: "Cambiá la URL a /juego"
    // El Router va a buscar en app-routing.module.ts y va a cargar el JuegoComponent
