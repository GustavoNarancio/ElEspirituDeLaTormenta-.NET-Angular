...
- Create Angular project with ng: `ng new elespiritudelatormenta.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`elespiritudelatormenta.client.esproj`).
